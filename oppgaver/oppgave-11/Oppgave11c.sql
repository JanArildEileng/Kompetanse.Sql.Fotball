...
(
  ...
  Select 'West Ham' as Team,'London' as City
   union
  Select 'Man United' as Team,'Manchester' as City
   union
  Select 'Man City' as Team,'Manchester' as City
   union
  Select 'Liverpool' as Team,'Liverpool' as City
    union
  Select 'Everton' as Team,'Liverpool' as City
...
select 
  City,
    Sum(TotalPoints) as TotalCityPoints
  from
(select 
...
JOIN City_Teams_CTE cityTeams on cityTeams.Team=x.Team
GROUP BY City
ORDER BY TotalCityPoints desc